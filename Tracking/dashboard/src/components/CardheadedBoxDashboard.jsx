...
const cardheadedBoxData = {
  name: 'Cardheaded',
  icon: Package,
  color: 'pink',
  total: 180,
  balance: 50, // warehouse available stock
  packing: 35, // boxes currently being packed
  finish: 35,  // boxes finished (should equal packing)
  dispatch: 35, // boxes dispatched (equals finish - no missing)
  delivered: 25,
  returned: 20,
  used: 130,
  unused: 50,
...
const CardheadedBoxDashboard = ({ onBack }) => {
  const data = cardheadedBoxData
  ...
  return (
    <div className="w-full p-4 bg-gradient-to-br from-pink-50 to-pink-100">
      <div className="max-w-7xl mx-auto flex flex-col space-y-4 pb-8">
        ...
        <div className="text-center animate-fade-in">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="bg-gradient-to-r from-pink-500 to-pink-600 text-white px-4 py-2 rounded-full text-sm font-medium">
              Cardheaded Boxes Dashboard
            </div>
          </div>
          <h1 className="text-2xl font-bold text-gray-800 mb-2">
            Cardheaded Box Management System
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-8 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">
                    Cardheaded Box Lifecycle Overview
                  </h2>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-800">
                  Cardheaded Box Delivery & Return Tracking
                </h2>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="space-y-3">
              <h2 className="text-base font-semibold text-gray-800">
                Cardheaded Box Usage Statistics
              </h2>
            ...
            <div className="bg-white rounded-lg p-4 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-gray-700">Cardheaded Box Distribution</span>
                </div>
...
export default CardheadedBoxDashboard
