...
// Static plastic box data
const plasticBoxData = {
  name: 'Plastic',
  icon: Package,
  color: 'blue',
  total: 250,
  balance: 70, // warehouse available stock
  packing: 50, // boxes currently being packed
  finish: 50,  // boxes finished (should equal packing)
  dispatch: 50, // boxes dispatched (equals finish - no missing)
  delivered: 40,
  returned: 30,
  used: 180,
  unused: 70,
...
const PlasticBoxDashboard = ({ onBack }) => {
  const data = plasticBoxData
  ...
  return (
    <div className="w-full p-4 bg-gradient-to-br from-blue-50 to-blue-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-8 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-semibold text-gray-800">
                    Plastic Box Lifecycle Overview
                  </h2>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-gray-800">
                  Plastic Box Delivery & Return Tracking
                </h2>
            ...
            <div className="bg-white rounded-lg p-4 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-medium text-gray-700">Plastic Box Distribution</span>
                </div>
...
export default PlasticBoxDashboard
